  ...
  switch (theme) {
    case 'material':
      return {
        ...
        buttonPrimary: 'bg-[#6750A4] dark:bg-[#D0BCFF] text-white dark:text-[#381E72] rounded-full px-6 py-3 font-medium shadow-md hover:shadow-xl hover:-translate-y-0.5 hover:bg-[#5F489A] dark:hover:bg-[#E8DEF8] active:translate-y-0 active:scale-[0.98] transition-all duration-300',
        buttonSecondary: 'bg-transparent text-[#6750A4] dark:text-[#D0BCFF] border border-[#79747E] dark:border-[#938F99] rounded-full px-6 py-3 font-medium hover:bg-[#6750A4]/10 dark:hover:bg-[#D0BCFF]/10 hover:shadow-sm active:scale-[0.98] transition-all',
    ...
    case 'glass':
      return {
        ...
        card: 'bg-white/70 dark:bg-slate-800/60 backdrop-blur-xl border border-white/50 dark:border-white/5 rounded-3xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all p-6 duration-300',
        ...
        // Buttons (Enhanced Hover/Active)
        buttonPrimary: 'bg-slate-900 dark:bg-blue-600 text-white hover:bg-slate-800 dark:hover:bg-blue-500 border border-transparent rounded-2xl px-6 py-3 font-semibold shadow-md hover:shadow-xl hover:-translate-y-0.5 transition-all active:scale-[0.98] active:translate-y-0 backdrop-blur-sm',
        buttonSecondary: 'bg-white/50 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:bg-white/80 dark:hover:bg-white/20 hover:border-slate-300 dark:hover:border-white/20 text-slate-700 dark:text-slate-200 rounded-2xl px-6 py-3 font-medium transition-all active:scale-[0.98]',
        ...
        inputWrapper: 'bg-white/60 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-2xl px-4 flex items-center min-h-[52px] transition-all duration-300 focus-within:bg-white dark:focus-within:bg-black/40 focus-within:border-blue-500/50 focus-within:shadow-md focus-within:-translate-y-0.5',
    ...
    case 'neumorphism':
      return {
        ...
        card: 'bg-[#E0E5EC] dark:bg-[#292d3e] rounded-3xl shadow-[9px_9px_16px_#a3b1c6,-9px_-9px_16px_#ffffff] dark:shadow-[8px_8px_16px_#1f2330,-8px_-8px_16px_#33374a] p-6 border-none hover:-translate-y-0.5 transition-transform duration-300', 
        ...
        // Buttons (Enhanced Hover/Active)
        buttonPrimary: 'bg-[#E0E5EC] dark:bg-[#292d3e] text-[#2563eb] dark:text-[#60a5fa] font-bold rounded-2xl px-6 py-3 shadow-[6px_6px_12px_#a3b1c6,-6px_-6px_12px_#ffffff] dark:shadow-[6px_6px_12px_#1f2330,-6px_-6px_12px_#33374a] hover:-translate-y-0.5 hover:shadow-[8px_8px_16px_#a3b1c6,-8px_-8px_16px_#ffffff] dark:hover:shadow-[8px_8px_16px_#1f2330,-8px_-8px_16px_#33374a] active:shadow-[inset_4px_4px_8px_#a3b1c6,inset_-4px_-4px_8px_#ffffff] dark:active:shadow-[inset_4px_4px_8px_#1f2330,inset_-4px_-4px_8px_#33374a] transition-all active:translate-y-[1px]',
        buttonSecondary: 'bg-[#E0E5EC] dark:bg-[#292d3e] text-[#64748b] dark:text-[#94a3b8] font-medium rounded-2xl px-6 py-3 shadow-[5px_5px_10px_#a3b1c6,-5px_-5px_10px_#ffffff] dark:shadow-[5px_5px_10px_#1f2330,-5px_-5px_10px_#33374a] hover:-translate-y-0.5 hover:shadow-[6px_6px_12px_#a3b1c6,-6px_-6px_12px_#ffffff] active:shadow-[inset_4px_4px_8px_#a3b1c6,inset_-4px_-4px_8px_#ffffff] dark:active:shadow-[inset_4px_4px_8px_#1f2330,inset_-4px_-4px_8px_#33374a] transition-all',
    ...
    default:
      return {
        ...
        card: 'bg-white dark:bg-[#2C2C2C] rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300',
        ...
        // Buttons (Enhanced Hover/Active)
        buttonPrimary: 'bg-[#0078D4] hover:bg-[#106EBE] text-white rounded-xl px-6 py-3 font-semibold shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all active:scale-[0.98] active:translate-y-0',
        buttonSecondary: 'bg-white dark:bg-[#3B3A39] border border-[#8A8886] hover:bg-[#F3F2F1] dark:hover:bg-[#484644] text-[#201F1E] dark:text-white rounded-xl px-6 py-3 font-semibold hover:shadow-sm transition-all active:scale-[0.98]',
