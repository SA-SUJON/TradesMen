  ...
  switch (theme) {
    case 'material':
      return {
        ...
        card: 'bg-[#F7F2FA] dark:bg-[#2B2930] rounded-3xl shadow-sm border border-transparent dark:border-[#49454F] p-6 transition-all hover:shadow-md',
    ...
    case 'glass':
      return {
        ...
        card: 'bg-white/10 dark:bg-black/30 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl shadow-xl p-6 hover:bg-white/15 dark:hover:bg-black/40 transition-colors',
    ...
    case 'neumorphism':
      return {
        ...
        // Tabs
        tabActive: 'text-blue-600 dark:text-blue-400 font-bold shadow-[inset_5px_5px_10px_#a3b1c6,inset_-5px_-5px_10px_#ffffff] dark:shadow-[inset_5px_5px_10px_#1f2330,inset_-5px_-5px_10px_#33374a] rounded-xl',
    ...
    default:
      return {
        ...
        card: 'bg-white dark:bg-[#2B2B2B] rounded-xl shadow-sm border border-[#E1DFDD] dark:border-[#484644] p-6 hover:shadow-md transition-shadow',
