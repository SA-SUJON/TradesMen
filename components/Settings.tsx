        ...
        <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1 w-full">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <div className="text-[10px] font-bold opacity-50 uppercase tracking-[0.2em] mb-0.5">Architect</div>
                        <div className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-violet-600 animate-gradient leading-none">SA SUJON</div>
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    <a href="mailto:hcentury346@gmail.com" className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 transition-all group">
                        <div className="p-2 bg-red-100 text-red-600 rounded-full group-hover:scale-110 transition-transform"><Mail className="w-4 h-4" /></div>
                        <span className="text-sm font-medium opacity-80 group-hover:opacity-100">
                            <span className="group-hover:hidden">View Email Address</span>
                    ...
                    <a href="tel:+8801821295207" className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 transition-all group">
                        <div className="p-2 bg-green-100 text-green-600 rounded-full group-hover:scale-110 transition-transform"><Phone className="w-4 h-4" /></div>
                        <span className="text-sm font-medium opacity-80 group-hover:opacity-100">
                            <span className="group-hover:hidden">View Phone Number</span>
                    ...
                    <a href="https://github.com/SA-SUJON/TradesMen/" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-white/5 transition-all group">
                        <div className="p-2 bg-gray-800 text-white rounded-full group-hover:scale-110 transition-transform"><Github className="w-4 h-4" /></div>
